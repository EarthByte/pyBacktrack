...
def find_rift_start_end_times(
    ...
    for continent_sediment_point_group_index in range(num_continent_sediment_point_groups):
        print ('  reconstructing group', continent_sediment_point_group_index, 'of', num_continent_sediment_point_groups)

        continent_sediment_point_start_index = continent_sediment_point_group_index * num_continent_sediment_point_per_group
        if continent_sediment_point_group_index == num_continent_sediment_point_groups - 1:
            num_continent_sediment_points_in_group = num_continent_sediment_points - continent_sediment_point_start_index
        else:
            num_continent_sediment_points_in_group = num_continent_sediment_point_per_group
        ...
        for point_index in range(num_continent_sediment_points_in_group):
            ...
            if (rift_start_time is not None and
                ...
                continent_sediment_rift_start_points.append(
                        (initial_point[0], initial_point[1], rift_start_time))
                continent_sediment_rift_end_points.append(
