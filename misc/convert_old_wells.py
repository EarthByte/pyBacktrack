...
def convert_dat_file(
        ...
        lithologies):
    """
    Reads the ".dat" filename and converts to pyBacktrack format
    (with '_pybacktrack' suffixed to the file's basename).
    ...
    if well_name in well_locations:
        ...
        well_latitude, well_longitude = None, None
        warnings.warn('Not writing well location for well file {0}. Cannot find a well location with well name "{1}".'.format(
    ...
    for layer_index in range(num_layers):
        ...
        for lithology_component_index in range(0, 8):
            lithology_fraction_column_index = 20 + 5 * lithology_component_index
            ...
            if lithology_fraction_string:
                ...
                lithology_components.append((DAT_LITHOLOGY_NAMES[lithology_component_index], lithology_fraction))
...
if __name__ == '__main__':
    ...
    # Input data files.
    well_locations_file = 'nwshelf_wells/WELL_LOCATIONS.txt'
