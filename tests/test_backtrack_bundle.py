...
def test_backtrack_bundle_ODP(tmpdir):
    """Test ODP well site using backtrack_and_write_decompacted function in backtrack_bundle module."""
...
def test_backtrack_bundle_DSDP(tmpdir):
    """Test DSDP well site using backtrack_and_write_decompacted function in backtrack_bundle module."""
