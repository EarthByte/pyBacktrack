...
from .backtrack import \
    ...
    COLUMN_PALEO_LONGITUDE as BACKTRACK_COLUMN_PALEO_LONGITUDE, \
    COLUMN_PALEO_LATITUDE as BACKTRACK_COLUMN_PALEO_LATITUDE, \
    COLUMN_SEA_LEVEL as BACKTRACK_COLUMN_SEA_LEVEL, \
    COLUMN_COMPACTED_DENSITY as BACKTRACK_COLUMN_COMPACTED_DENSITY, \
    COLUMN_COMPOSITE_POROSITY as BACKTRACK_COLUMN_COMPOSITE_POROSITY, \
    COLUMN_COMPOSITE_DECAY as BACKTRACK_COLUMN_COMPOSITE_DECAY
...
from .backstrip import \
    ...
    COLUMN_PALEO_LONGITUDE as BACKSTRIP_COLUMN_PALEO_LONGITUDE, \
    COLUMN_PALEO_LATITUDE as BACKSTRIP_COLUMN_PALEO_LATITUDE, \
    COLUMN_SEA_LEVEL as BACKSTRIP_COLUMN_SEA_LEVEL, \
    COLUMN_COMPACTED_DENSITY as BACKSTRIP_COLUMN_COMPACTED_DENSITY, \
    COLUMN_COMPOSITE_POROSITY as BACKSTRIP_COLUMN_COMPOSITE_POROSITY, \
    COLUMN_COMPOSITE_DECAY as BACKSTRIP_COLUMN_COMPOSITE_DECAY
...
__all__ = [
    ...
    'BACKTRACK_COLUMN_PALEO_LONGITUDE',
    'BACKTRACK_COLUMN_PALEO_LATITUDE',
    'BACKTRACK_COLUMN_SEA_LEVEL',
    'BACKTRACK_COLUMN_COMPACTED_DENSITY',
    'BACKTRACK_COLUMN_COMPOSITE_POROSITY',
    'BACKTRACK_COLUMN_COMPOSITE_DECAY',
    ...
    'BACKSTRIP_COLUMN_PALEO_LONGITUDE',
    'BACKSTRIP_COLUMN_PALEO_LATITUDE',
    'BACKSTRIP_COLUMN_SEA_LEVEL',
    'BACKSTRIP_COLUMN_COMPACTED_DENSITY',
    'BACKSTRIP_COLUMN_COMPOSITE_POROSITY',
    'BACKSTRIP_COLUMN_COMPOSITE_DECAY',
