...
COLUMN_SEA_LEVEL = 16
COLUMN_COMPACTED_DENSITY = 17
COLUMN_COMPOSITE_POROSITY = 18
COLUMN_COMPOSITE_DECAY = 19
...
def write_well(
    ...
    .. versionchanged:: 1.5
        ...
        - Added ``pybacktrack.BACKSTRIP_COLUMN_PALEO_LONGITUDE``, ``pybacktrack.BACKSTRIP_COLUMN_PALEO_LATITUDE``, ``pybacktrack.BACKSTRIP_COLUMN_SEA_LEVEL``,
          ``pybacktrack.BACKSTRIP_COLUMN_COMPACTED_DENSITY``, ``pybacktrack.BACKSTRIP_COLUMN_COMPOSITE_POROSITY`` and ``pybacktrack.BACKSTRIP_COLUMN_COMPOSITE_DECAY``
