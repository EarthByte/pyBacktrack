...
from pybacktrack.util.interpolate import main
...
if __name__ == '__main__':
    ...
    raise RuntimeError("Only use as 'python -m pybacktrack.util.interpolate_cli ...', not as 'import pybacktrack.util.interpolate_cli'.")
