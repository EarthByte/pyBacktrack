...
There are traditional paleobathymetry grids available for the default plate model in pyBacktrack (Zahirovic 2022) for both of its reference frames:

* `paleomagnetic reference frame <https://repo.gplates.org/webdav/PlateModel_Age_SR_Grids/Zahirovic_etal_2022_GDJ/02_AgegridsUsingTopologies/PaleomagneticFrame/PaleobathymetryGrids/GDH1/>`__ (anchor plate ``701701``) and
* `mantle reference frame <https://repo.gplates.org/webdav/PlateModel_Age_SR_Grids/Zahirovic_etal_2022_GDJ/02_AgegridsUsingTopologies/OptimisedMantleFrame/PaleobathymetryGrids/GDH1/>`__ (anchor plate ``0``).
