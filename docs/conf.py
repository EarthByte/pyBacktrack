...
# Remove the patch version from pybacktrack.__version__.
version = re.sub(r'(\d+\.\d+).*$', r'\1', pybacktrack.__version__)
# The full version, including alpha/beta/rc tags.
release = pybacktrack.__version__
